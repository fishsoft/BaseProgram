...
/**
 * Created by weiyx on 2016/12/20.
 * Company: bmsh
 * Description:
 */
public class CpTextItemView3 extends LinearLayout implements View.OnClickListener, IBmzgView {
    private TextView tvTitle;
    private TextView etVal;
    ...
    public CpTextItemView3(Context context) {
        this(context, null);
    }

    public CpTextItemView3(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context, attrs);
    }

    public CpTextItemView3(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initView(Context context, AttributeSet attrs) {
        ...
        View view = LayoutInflater.from(getContext()).inflate(R.layout.include_cp_text_item3, this);

        tvTitle = (TextView) view.findViewById(R.id.tv_title);
        etVal = (TextView) view.findViewById(R.id.et_val);
    ...
    public void onClick(View v) {
        ...
        if (mCpViewClickListener != null) {
            mCpViewClickListener.onItemClick(this, v == this ? false : true);//v, v == this ? false : true);
        }
    }
